<template>
  <v-container fluid>
    <h2 class="mb-4" style="color: #FFD700; text-align: center; font-weight: bold; font-size: 2em; text-shadow: 2px 2px 4px #000000;">YOUR ITEMS</h2>
...
// Load items for this proposal when the page loads
